...
const VarsconServicesHero = () => {
  return (
    <section className="w-full flex flex-col gap-[120px] items-center justify-center pb-[77px]">
      <div className="w-full flex flex-col items-center justify-center pt-[200px] bg-[url(/assets/products/varscon-services-bg.png)] bg-cover bg-no-repeat">
        <Container className="flex flex-col gap-6 items-center">
          <div className="w-fit flex gap-3 items-center py-1 px-2.5 rounded-[20px] bg-[#00ca720f]">
            ...
            <p className="font-inter text-[24px] text-[#00CA72]/90 leading-[32.234px]">
              Varscon services
            </p>
          </div>
          <div className="w-full max-w-[960px] flex flex-col items-center gap-3">
            <h2 className="w-full max-w-[827px] text-[#1E1E1E] font-publicSans text-[64px] text-center font-semibold leading-[64px]">
              Powering Product Excellence for{" "}
              <span className="text-[#00CA72]">Varscon</span> Clientele
            </h2>
            <p className="w-full font-inter text-[24px] text-center leading-[32.234px] text-black/55">
