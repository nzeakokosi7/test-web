...
const MotherbotHero = () => {
  return (
    <section className="w-full bg-[#F5F5F5] pb-[50px]">
      <section className="w-full flex flex-col items-center justify-center bg-[url(/assets/products/motherbot-hero-mobile-bg.png)] md:bg-[url(/assets/products/motherbot-hero-bg.png)] bg-cover bg-no-repeat rounded-b-[40px] md:rounded-b-[80px] pt-[60px] ">
